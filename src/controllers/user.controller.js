...
const loginUser = asyncHandler( async (req, res) => {
    ...
    //mongodb operator which finds whether username or email is present
    ...
    //the user which is instantiated by us consists of the methods which we declared in the User model not User
